...
const AboutPageDev = ({ dataAllPost, dataSiteSettings }) => (
  <Wrapper pageType="about" settings={dataSiteSettings?.SiteSettings}>
    <Head>
    ...
    <div className="mt-12 mb-20 mx-auto max-w-md px-4 grid gap-8 sm:max-w-lg sm:px-6 lg:px-8 lg:grid-cols-3 lg:max-w-7xl">
      <p>
        This is the <span className="font-black">senior frontend developer / about</span> page
      </p>
    </div>
    <BlogSection
